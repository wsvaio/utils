 ...
 * @returns Blob 对象
 */
function canvasToFile(canvas: HTMLCanvasElement, type: string, quality: number) {
 ...
 */
export async function compressPicture(file: File, { quality = 0.5, width = 1920, height = 1080 } = {}) {
