 ...
 * @returns 合并后的对象。
 */
export function merge<Obj1 extends object, Obj2 extends DeepPartial<Obj1> | object>(obj1: Obj1,	obj2: Obj2,	options = {} as { deep?: number; overwrite?: boolean; del?: boolean; has?: boolean }) {
  ...
  if (Array.isArray(obj1) && Array.isArray(obj2)) {
    if (del && obj1.length > obj2.length)
